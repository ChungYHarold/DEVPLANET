...
<div class="resumePage resumePageComplete">
    ...
    <div class="resumeHeader">
        <div class="container">
            <a href="http://localhost/devplanet/project_user/1.main/main_page_loged.jsp" class="logo"><img src="http://localhost/devplanet/images/devplanet_logo.png" style="width: 100px; height: auto;" ></a>
            <div class="links">
                <a href="http://localhost/devplanet/project_user/1.main/main_page_loged.jsp" class="link linkHome">개인회원 홈</a>
                <a href="http://localhost/devplanet/project_user/4.resume/resume_present.jsp" class="link linkManage">이력서 관리</a>
            </div>
        </div>
    </div>
    ...
    <div class="resumeWrapper">
    	<div class="resumeContainer resumeContainerComplete">
            ...
            <a href="http://localhost/devplanet/project_user/4.resume/resume_present.jsp" class="button buttonViewWritten">작성한 이력서 보기</a>
<div class="asd">
</div>
 <!-- footer 시작 -->
