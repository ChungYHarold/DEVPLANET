...
<div class="globalBar globalBarSub" id="globalBar">
	<div class="innerBar">
		...
		<div id="gnb">
			...
			<span class="bar">
				<span class="title">
					<img src="http://localhost/devplanet/project_user/3.idPass/images/h_cc_schpwd.gif" alt="비밀번호 찾기">
				</span>
			</span>
			</h1>
			<div class="secNav">
...
<div id="wrap">
	...
	<div id="container">
		...
		<form action="http://localhost/devplanet/project_user/3.idPass/compPw_process.jsp" name="compPwFrm" id="compPwFrm" method="post">
		...
		<input type="hidden" name="userId" value="${ userId }"/>
			...
			<div class="mbrSec mbrCCSch mbrCCSchPwdChange">
				<h2 class="mbrHeading2"><img src="http://localhost/devplanet/project_user/3.idPass/images/mbr_h_mng_pwd_change.gif" alt="비밀번호 재설정"></h2>
