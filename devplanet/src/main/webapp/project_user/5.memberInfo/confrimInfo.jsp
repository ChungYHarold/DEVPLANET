...
<div id="wrap">
	...
	<div id="container">
		<div id="content">
			<form id="con_frm" name="con_frm" method="post" action="http://localhost/devplanet/project_user/5.memberInfo/confirmInfo_process.jsp">
<!--skip은 안보임  -->	<h1 class="skip"><!--비밀번호 확인--></h1>
			<fieldset>
				<!-- <legend>비밀번호 확인 정보 입력폼</legend> -->
				<div class="mbrSec mbrMngPWD">
					<h2 class="mbrHeading2"><img src="http://localhost/devplanet/project_user/images/mbr_h_mng_pwd.gif" alt="비밀번호 확인"></h2>
